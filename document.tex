...
In the next example will check in what extent extrapolation outside the calibration range is possible.
...
fixing the rotation along axis 1 of the detector ($rot_1=0$) has been kept fixed to
...
The insert is a close-up view on the first peak showing the sharpness of the peak depending on the model.
In the simple model, in orange, only $rot_2$ depends linearly on the goniometer angle (6 $dof$).
The while the advanced model, in blue, both rotation $rot_1$ and $rot_2$ depend linearly on the goniometer angle (7 $dof$).}
\end{center}
\end{figure}
