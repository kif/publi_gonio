...
In the next example will validate that extrapolation outside the calibration range is also possible.
...
Both shifts being small suggests to use a first order correction on $rot_1$.
...
The signal/noise ratio was found to be much better with an acquisition time 24 \times
